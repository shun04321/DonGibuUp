...
<!-- 게시판 목록 시작 -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/subscriptionList.css"
	type="text/css">
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/jquery-3.7.1.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/subscription/subscriptionList.js"></script>
<div class="page-container">
	<div class="tabs">
		<button class="tab-button active"
			onclick="openTab(event, 'subscriptionList')">나의 정기기부 목록</button>
		<button class="tab-button" onclick="openTab(event, 'paymentHistory')">정기기부
			결제내역</button>
	</div>
			...
			<c:forEach var="subscription" items="${list}">
				<div class="item_subscribe">
					<dl class="header-item">
						<dt>
							<a
								href="${pageContext.request.contextPath}/subscription/subscriptionDetail?sub_num=${subscription.sub_num}">
								<img
								src="${pageContext.request.contextPath}/upload/${subscription.donationCategory.dcate_icon}"
								alt="기부처 아이콘"> ${subscription.donationCategory.dcate_name}
								/ ${subscription.donationCategory.dcate_charity}
							</a>
						</dt>
						<dd>
							<a
								...
								<c:if test="${subscription.sub_status==0}">
									...
									test="${subscription.sub_status==1}">
                                    상태 : 기부 중단 >
                                </c:if>
							</a>
						</dd>
					...
					<div class="cont-item">
						<dl class="info-item">
							<dt>기부금액</dt>
							<dd class="sub-price"
								data-original-price="${subscription.sub_price}">${subscription.sub_price}원</dd>
						</dl>
						<dl class="info-item">
							<dt>결제일</dt>
