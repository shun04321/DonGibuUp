...
<div class="page-main">
	...
	<div>
		<a href="faqlist?">전체</a> |
		<a href="faqlist?category=0">정기기부</a> |
		<a href="faqlist?category=1">기부박스</a> |
		<a href="faqlist?category=2">챌린지</a> |
		<a href="faqlist?category=3">굿즈샵</a> |
		<a href="faqlist?category=4">기타</a>
	</div>
	...
	<c:if test="${!empty list}">
		...
		<c:forEach var="faq" items="${list}">
			<li class="user-faq-item">
				...
				<div class="faq-answer-text" style="display:none">A. ${faq.faq_answer}</div>
			</li>
		</c:forEach>
		</ul>
	</c:if>
