            ...
            <c:if
               ...
               <div class="product-item">
                  ...
                  <div class="product-details">
                     ...
                     <span class="price">가격: <fmt:formatNumber value="${goods.item_price}" type="number" groupingUsed="true" /> 원</span>
                      <span class="stock">재고: <fmt:formatNumber value="${goods.item_stock}" type="number" />ea</span>
                  </div>
